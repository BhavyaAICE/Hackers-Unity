              ...
              <div className="space-y-4">
                <div>
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className={`text-xs font-semibold uppercase px-2 py-1 rounded-full ${event.status === 'upcoming' ? 'bg-green-500/10 text-green-500' :
                ...
                <div className="flex flex-wrap gap-2">
                  <Link to={`/admin/events/edit/${event._id}`} className="flex-1">
                  ...
                  {event.eventType === 'hackathon' && (
                    <Link to={`/admin/hackathon/${event._id}`}>
