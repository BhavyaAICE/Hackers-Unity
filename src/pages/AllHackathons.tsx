...
import type { ApiHackathon } from "@/types/api.types";

const AllHackathons = () => {
  const [hackathons, setHackathons] = useState<ApiHackathon[]>([]);
  ...
  const fetchHackathons = async () => {
    try {
      const { hackathons: data } = await api.get<{ hackathons: ApiHackathon[] }>("/api/hackathons");
      setHackathons(data);
    } catch (err) {
          ...
          {loading ? (
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {hackathons.map((hackathon, index) => {
                ...
                const imageUrl = hackathon.thumbnailImage || hackathon.bannerImage;
                      ...
                      <div className="p-6 flex-1 flex flex-col">
                        ...
                        <div className="space-y-2 text-sm text-muted-foreground flex-1">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            {hackathon.registrationCount}+ Participants
                          </div>
                        </div>
                        ...
                        <div className="mt-6">
                          {hackathon.externalLink ? (
                            status === "completed" ? (
                              <a href={hackathon.externalLink} target="_blank" rel="noopener noreferrer" className="block">
