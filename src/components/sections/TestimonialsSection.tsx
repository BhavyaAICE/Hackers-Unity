...
import type { ApiTestimonial } from "@/types/api.types";

const AUTO_SLIDE_INTERVAL = 5000;

// Sample testimonials fallback
const sampleTestimonials: ApiTestimonial[] = [
  {
    _id: "1",
    name: "Arjun Sharma",
    role: "Full Stack Developer",
    organization: "Microsoft",
    testimonial: "Hacker's Unity transformed my career. The hackathons pushed me beyond my limits and helped me connect with amazing mentors who guided me to land my dream job.",
    rating: 5,
    isFeatured: true,
    displayOrder: 1,
    isActive: true,
  },
  {
    ...
    role: "ML Engineer",
    organization: "Google",
    testimonial: "Being part of this community opened doors I never knew existed. The workshops on AI/ML were top-notch, and I met my co-founders at one of their hackathons.",
    rating: 5,
    isFeatured: true,
    displayOrder: 2,
    isActive: true,
  },
  {
    ...
    testimonial: "The Web3 hackathons organized by Hacker's Unity were exceptional. I learned more in those 48 hours than I did in months of self-study.",
    rating: 5,
    isFeatured: true,
    displayOrder: 3,
    isActive: true,
...
const TestimonialsSection = () => {
  const [testimonials, setTestimonials] = useState<ApiTestimonial[]>(sampleTestimonials);
  ...
  const fetchTestimonials = async () => {
    try {
      const { testimonials: data } = await api.get<{ testimonials: ApiTestimonial[] }>("/api/content/testimonials");
